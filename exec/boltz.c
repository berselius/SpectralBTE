...
int main(int argc, char **argv) {
  ...
  if (weightgenFlag == 0) {
    ...
    if(isoFlag == 1) { //load AnIso weights generated by the AnIso weight generator (seperate program)
      ...
      printf("initialize_weights_AnIso takes %f seconds.\n", ((double)(clock() - function_time)) / CLOCKS_PER_SEC);
    }
    else {
      ...
      printf("precomputing weights: i x j = %d number of function calls of initialize_weights takes %f seconds.\n", num_species * num_species, ((double)(clock() - function_time)) / CLOCKS_PER_SEC);
    }
  }
  else {
    for (i = 0; i < num_species; i++)
