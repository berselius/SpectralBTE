...
int main(int argc, char **argv) {
  ...
  int potFlag = 0;  //Set to 1 if using a potential-generated cross section (under development...)
  if(potFlag == 1)
    initialize_weights_pot(N, zeta, L_v, weightFlag, conv_weights[0], "Debye_Huckel_rep");
  else {
